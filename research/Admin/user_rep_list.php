...
if(isset($_POST['submit'])){
    ...
    <tbody>';
      ...
      echo '<tr>';
			     echo "<td>" . $row['repdescription'] ."</td>";
			echo "<td>" . $row['contactno'] ."</td>";
			echo "<td>" . $row['firedate'] ."</td>";
			echo "<td>" . $row['firetime'] ."</td>";
			echo "<td>" . $row['Status'] ."</td>";
			echo "<td><a href='update_user_report.php?id=".$row['urid']."' class='alert-link alert-info'>Update
				  </td>";
      echo'</tr>
    </tbody>';
	}
  echo'</table>';
		...
		$sql = mysqli_query($con,"SELECT * FROM userreport WHERE firedate like '%$_POST[origin]%' || Status like '%$_POST[origin]%' || repdescription like '%$_POST[origin]%'");		
		if(!$sql){
			echo "No result found";
		}else{		
			 echo '<table class="table table-condensed table-striped table-bordered table-responsive">
