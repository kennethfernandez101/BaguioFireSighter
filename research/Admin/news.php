...
$sql = "INSERT INTO newstbl (datetime,title,image_path,caption) VALUES (NOW(),'$title','$filepath','$compose')";
		if (mysqli_query($con,$sql)){
		}else{
		}

$sq2 = "INSERT INTO slideshow (title,image_path,caption,datetime) VALUES ('$title','$filepath','$compose',NOW())";
		if (mysqli_query($con,$sq2)){
			...
			$activity = "".$staff_name." Added a News";
			//Input a Log Event			
...
<script>
			...
			window.alert("News Successfully Added");
  			...
  			<div class="container-fluid">
                ...
                <span class=" caret"></span></a>
          		...
          		<li class="<?php echo $disable; ?>"><a tabindex="-1" href="<?php echo $link_view_firefighter ?>">View firefighter</a></li>
                                                        ...
                                                        <li class="active"><a href="news.php">Add News</a>
...
<div class="form-group">
      					<label for="lastname" class="col-sm-2 control-label">Choose Photo:</label>
      						<div class="col-sm-6">
      							<input type="file" class="form-control" id="photo" name="file_img">
                    ...
                    <div class="form-group">
      					<label for="lastname" class="col-sm-2 control-label">Compose:</label>
      						<div class="col-sm-9">
      							<textarea name="compose" cols="50" rows="8" id="compose" ><?php echo isset($_POST['compose']) ? htmlspecialchars($_POST['compose']) : ''; ?></textarea>
