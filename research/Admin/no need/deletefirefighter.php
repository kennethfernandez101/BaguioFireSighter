...
$sql = mysqli_query($con, "DELETE FROM table1 WHERE fighter_id ='$id'");
$sql = mysqli_query($con, "DELETE FROM fireman WHERE fighter_id = '$id'");
if ($sql){
	
								
							//getting the data of staff/Admin for documenting Log-Reports
			$staff_name = $staff_fname." ".$staff_lname;			
			$activity = "".$staff_name." Deleted a Firefighter ";
			//Input a Log Event			
