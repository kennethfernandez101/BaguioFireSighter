...
if (isset($_POST['submit'])){
	...
	if (empty($_POST['origin_name'])){
		...
		if (($_POST['origin_name']!="")){
			$sql = "INSERT INTO origin (origin_name) VALUES ('$_POST[origin_name]')";
                           ...
                           <a class="dropdown-toggle" data-toggle="dropdown" href="">Maps
       					   <span class="caret"></span></a>
                                    ...
                                    <li class="dropdown-submenu">
                                                    ...
                                                    <li class="active"><a tabindex="-1" href="addorigin.php">Add Cause/Origin</a></li>
...
<h2 class="forms">Insert Cause/Origin</h2>
</div>
...
<label for="lastname" class="col-sm-2 control-label">Add Cause/Origin</label>
      						<div class="col-sm-6">
      							<input type="text" class="form-control" id="origin_id" name="origin_name" value="<?php echo isset($_POST['origin_name']) ? htmlspecialchars($_POST['origin_name']) : ''; ?>">
