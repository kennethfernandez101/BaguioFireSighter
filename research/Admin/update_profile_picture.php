...
if (isset($_POST['submit'])){
	...
	$sql3 = "UPDATE admintbl SET firemenpict = '$filepath'";
	...
	if (!mysqli_query($con,$sql3)){
			...
			$activity = "".$staff_name." Edited Profile Picture";
			//Input a Log Event			
...
<h2 class="forms">Update Profile Picture</h2>
</div>
...
<div class="form-group">
      					<label for="lastname" class="col-sm-2 control-label">Choose Photo:</label>
      						<div class="col-sm-6">
      							<input type="file" class="form-control" id="file_image" name="file_img" accept="image/*">
