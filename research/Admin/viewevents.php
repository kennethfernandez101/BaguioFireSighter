...
<?php 
	$sql1 = mysqli_query($con,"SELECT * FROM eventstbl ORDER BY edateandtime DESC");		
		if(!$sql1){
    ...
    <div class="row" align="center">
    	<div class="col-sm-12">
            ...
            <h5><?php echo $row['edateandtime'];?></h5> 
            <img class="img-responsive" src="<?php echo $row['eimage_path'];?>" alt="News" width="400" height="100">
        	<p><?php echo $row['ecaption']." ";?> <?php echo "<a href='editevents.php ?id=".$row['event_id']." ' class='alert-link alert-info'>Click here to Edit...</a>"?></p>
        </div>
    </div>
    <hr/>
    <?php
