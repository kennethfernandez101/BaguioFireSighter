...
<?php 
    ...
    <div class="row" align="center">
    	<div class="col-sm-12">
            ...
            <img class="img-responsive" src="<?php echo $row['image_path'];?>" alt="News" width="400" height="100">
        	<p><?php echo $row['caption']." ";?> <?php echo "<a href='editnews.php ?id=".$row['news_id']." ' class='alert-link alert-info'>Click here to Edit...</a>"?></p>
        </div>
    </div>
    <hr/>
    <?php
