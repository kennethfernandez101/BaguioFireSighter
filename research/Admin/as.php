        			...
        			<span class="icon-bar"></span>
                           ...
                           <a class="dropdown-toggle" data-toggle="dropdown" href="viewnews.php">News &amp; Events
       					   <span class="caret"></span></a>
        							...
        							<li class="active"><a href="as.php">About Us</a></li>
...
<?php 
    ...
    <div class="row" align="center">
    	<div class="col-sm-12">
        <img class="img-responsive" src="<?php echo $row['firemenpict'];?>" alt="News" width="100" height="100">
