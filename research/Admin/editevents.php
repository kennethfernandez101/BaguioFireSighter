...
if (isset($_POST['submit'])){
	...
	$sql3 = "UPDATE eventstbl SET etitle='$etitle', eimage_path = '$filepath', ecaption = '$ecompose'";
...
$sql1= mysqli_query ($con,"select * from eventstbl where event_id = '$id'");
...
<label for="lastname" class="col-sm-2 control-label">Title:</label>
      						<div class="col-sm-6">
      							<input type="text" class="form-control" id="etitle" name="etitle" value="<?php echo $sql2 ['etitle']  ?>">
...
<div class="form-group">
      					<label for="lastname" class="col-sm-2 control-label">Choose Photo:</label>
      						<div class="col-sm-6">
      							<input type="file" class="form-control" id="efile_image" name="efile_img" accept="image/*">
                    ...
                    <div class="form-group">
      					<label for="lastname" class="col-sm-2 control-label">Compose:</label>
      						<div class="col-sm-9">
      							<textarea name="ecompose" cols="50" rows="8" id="ecompose" value="ecaption"></textarea>
